...
bool DeviceDriverSet_IRrecv::DeviceDriverSet_IRrecv_Get(uint8_t *IRrecv_Get /*out*/)
{
  if (irrecv.decode(&results))
  {
    ...
    case /* constant-expression */ bRECV_9:
      /* code */ *IRrecv_Get = 14;
      break;
    case /* constant-expression */ aRECV_x:
    case /* constant-expression */ bRECV_x:
      /* code */ *IRrecv_Get = 15;
      break;
    case /* constant-expression */ aRECV_0:
    case /* constant-expression */ bRECV_0:
      /* code */ *IRrecv_Get = 16;
      break;
    case /* constant-expression */ aRECV_j:
    case /* constant-expression */ bRECV_j:
      /* code */ *IRrecv_Get = 17;
      break;
